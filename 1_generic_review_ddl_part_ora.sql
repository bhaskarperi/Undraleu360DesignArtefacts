...
(
	...
	master_consolidator_id  INTEGER  NULL 
);
CREATE TABLE cbp_criticality_level
(
	cbp_criticality_level_id  INTEGER  NOT NULL ,
...
(
	cbp_project_id  INTEGER  NOT NULL ,
	cbp_misc_property_id  INTEGER  NOT NULL ,
...
(
	...
	az_dtbricks_url VARCHAR2(255),
	az_dtbricks_token VARCHAR2(255)
);
...
(
	...
	vcs_content_identifier VARCHAR2(255),
	vcs_id INTEGER
);
...
ALTER TABLE cbp_user_proj_rel_branch
	ADD (CONSTRAINT  R2183 FOREIGN KEY (cbp_user_id) REFERENCES cbp_user_security(cbp_user_id));
ALTER TABLE cbp_user_proj_rel_branch
	ADD (CONSTRAINT  R2184 FOREIGN KEY (cbp_project_id) REFERENCES cbp_project(cbp_project_id));	
...
ALTER TABLE cbp_user_proj_rel_branch
	ADD (CONSTRAINT  R2185 FOREIGN KEY (res_id) REFERENCES cbp_tkt_res(res_id));	